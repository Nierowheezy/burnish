...
| **The Future** | (in repo) | Burnish's own body workhorse | Default Burnish tone |
...
| Family | Source | Voice | Best for |
| --- | --- | --- | --- |
| **Geist Mono** | Google | Geist's mono companion | Default Burnish mono, code, captions |
...
| **Workshop** *(Burnish's own theme)* | Free | The Future · Geist · Cabinet Grotesk | The Future · Switzer | The Future Mono · Geist Mono |
...
Pick a ratio. The default for Burnish work is **1.25** (major third). Build the scale from a 16px body, then clamp display sizes for responsive.
