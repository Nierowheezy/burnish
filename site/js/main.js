// Burnish — landing-page interactions.
...
const STORAGE_KEY = "burnish-theme";
...
const THEME_GENRES = {
  // editorial — the canonical Burnish voice
  specimen:  "editorial",
  newsprint: "editorial",
  atelier:   "editorial",
  garden:    "editorial",
...
const COPY = {
  specimen: {
    ...
    title: HERO_TITLE,
    lede: "Burnish is a skill for Claude Code, Cursor, and Codex. It encodes the anti-slop consensus — typography, colour, layout, motion, interaction — into one holistic ruleset your AI assistant will actually follow.",
    ctaLabel: "01 ⁄ Install",
    proofLabel: "Proof",
    ...
    attrib: "The rule Burnish is built around",
    salutation: "Dear designer,",
    letterBody: "Every LLM has been trained on the same templates. Without a firm hand, they all emit the same page. Burnish is the firm hand. It refuses the defaults, asks the questions that matter, and stamps the page so the next run produces something genuinely different.",
    signoff: "With care,",
    captionA: "Plate 01",
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty themes. Twenty-one named page shapes. Fifty component archetypes — fourteen navs, eight footers, four hero polish patterns. A 57-gate slop test that gates every output before it ships. Burnish is the rulebook the LLM never read.",
    ...
    attrib: "From the Burnish rule sheet",
  ...
  atelier: {
    ...
    letterBody: "We do not believe in defaults. The default is the average; we are looking for the specific. Every page Burnish touches is a small refusal of the average, in favour of a page that knows what it is.",
    signoff: "— the studio",
    captionA: "Workbench",
    captionB: "12 April",
  },
  ...
  almanac: {
    ...
    title: HERO_TITLE,
    lede: "A reference book of structural choices, indexed and cross-referenced. Burnish looks up the right page-shape for the brief and refuses to use the same one twice.",
    ...
    letterBody: "This page is a reference, not an argument. The numbers are the point: 21 macrostructures, 50 archetypes, 21 themes, 57 slop-test gates. Cross-referenced so the next page Burnish builds is genuinely different from the last.",
    signoff: "— editor",
    captionA: "Vol. III",
    captionB: "Plate 12",
  },
  ...
  studio: {
    eyebrow: "Studio · 2026",
    title: HERO_TITLE,
    lede: "We design and build distinctive products for ambitious teams. Burnish is our typography opinion, codified — twenty themes, twenty-one shapes, no defaults.",
    ctaLabel: "Engage",
    ...
    letterBody: "We started this studio because we kept being asked to build the same page, twelve different ways. Burnish is our argument: one brief, one shape — chosen, not defaulted to. Take a look.",
    signoff: "Yours,",
...
(() => {
  ...
  const REPO = "Nierowheezy/burnish";
  const CACHE_KEY = "burnish-star-count:" + REPO;   // key by repo — renames auto-invalidate
...
const T_TOOLTIP_KEY = "burnish-t-tooltip-seen";
