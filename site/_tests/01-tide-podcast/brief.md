...
> *"No pre-flight signals — proceeding with full Burnish stack."*
...
> *"This is the first Burnish v0.6.0 run for this project. No `.burnish/log.json` rotation needed."*
...
```
/* Burnish · macrostructure: Letter · H6 hero knobs: salutation=greeting, body=3 paragraphs, signoff=initials
