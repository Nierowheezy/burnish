# `burnish audit input.html`

> User invocation: *"burnish audit input.html"*

## Verbs loaded

- [`anti-patterns.md`](../../../skills/burnish/references/anti-patterns.md) — the named-tells library to score against
- [`structure.md`](../../../skills/burnish/references/structure.md) — for the structural-fingerprint check (gate 9)
- [`microinteractions.md`](../../../skills/burnish/references/microinteractions.md) — the timing/easing canon
...
Do **not** run `burnish refine` here. Run `burnish redesign` instead — `refine` preserves structure, and the structure itself is the primary problem. See [`../redesign/`](../redesign/) for what a redesign of a similar page looks like.
