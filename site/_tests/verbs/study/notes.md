...
Five-step pipeline (per [`SKILL.md`](../../../skills/burnish/SKILL.md) § `burnish study`):

1. **Refuse-or-proceed check** — public reference, not a paid template → proceed.
2. **Vision pass** — read the image into the structured-fields schema in [`study.md`](../../../skills/burnish/references/study.md). Output ten fields.
...
- [`references/study.md`](../../../skills/burnish/references/study.md) — the protocol, schema, and refusal heuristics.
- [`references/study-examples.md`](../../../skills/burnish/references/study-examples.md) — the three worked examples (Pentagram-style portfolio, Klim-specimen, Rauno-personal). The Pentagram example matched our screenshot most closely; the skill imitated the diagnosis structure.
- [`references/macrostructures.md`](../../../skills/burnish/references/macrostructures.md) — to name the page-shape (Specimen).
- [`references/component-cookbook.md`](../../../skills/burnish/references/component-cookbook.md) — for archetype names (H4 Margin-Number Display, Ft1 Single-Line Colophon).
- [`references/typography.md`](../../../skills/burnish/references/typography.md) — for the type-role vocabulary (italic-display + sans-body) and free / paid candidate pairings.
- [`references/color.md`](../../../skills/burnish/references/color.md) — for the warm-orange-at-low-chroma colour-anchor.
- [`references/microinteractions.md`](../../../skills/burnish/references/microinteractions.md) — for the hover-duration anti-pattern callout (the screenshot's 800 ms is too slow; should be 150–200 ms).
...
```
/* Burnish · macrostructure: Specimen · H4 hero knobs: number-column=margin, alignment=left-bias
